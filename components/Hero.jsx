export default function Hero() {
    return (
        <section className="h-[calc(100vh-300px)] mt-[64px] lg:mt-[72px]">
            <div className="grid lg:grid-cols-2 grid-rows-2 lg:grid-rows-1 h-full place-items-center bg-[url(/herobg.png)] bg-cover bg-[-300px_-100px] sm:bg-center xl:bg-[center_-150px]">
